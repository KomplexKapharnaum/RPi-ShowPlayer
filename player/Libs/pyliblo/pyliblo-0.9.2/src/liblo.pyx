...
cdef class ServerThread(_ServerBase):
    ...
    def __init__(self, port=None, proto=LO_DEFAULT, group="224.0.0.1", **kwargs):
        cdef char *cs
        ...
        self._server_thread = lo_server_thread_new_multicast(group, cs, _err_handler)
        if __exception:
            raise __exception
