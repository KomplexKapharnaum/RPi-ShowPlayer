...
def patch_msg(path, args, types, src,):
    patcher.patch(OSC.network.get_flag_from_msg(path, args, types, src))
...
def init(flag):
    ...
    OSC.DNCserver.add_method(None, None, patch_msg)       # TODO WE DO NOT NEED OSC FOR SCENARIO SYSTEM, deplace !
